...
class SudyGroupFilters extends Component {
    state =  {
        courseFilter: null,
    }
    ...
    filterByCourse = property => filter => {
        ...
        Api.get(`/courses/${filter.value}/study_groups`).then(response => {
...
export default withSnackbar(withStyles(styles)(SudyGroupFilters));